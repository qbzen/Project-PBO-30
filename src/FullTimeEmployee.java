...
public class FullTimeEmployee extends Employee {
    ...
    // KONSTRUKTOR BARU: Hanya 4 parameter data
    ...
    /**
     * Hitung upah lembur per jam berdasarkan formula 1/173 dari Gaji Pokok
     * (Asumsi Gaji Pokok = Upah Sebulan + Tunjangan Tetap)
     */
    ...
    /**
     * SETTER BARU untuk Base Salary (disimpan di Model)
     * Digunakan ketika Golongan di-update di EmployeeRepository.
     */
