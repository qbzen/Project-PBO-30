...
/**
 * ReportPanel - Final Version with all updates: 
 * 1. Corrected column headers (13 total: including Dibayar Oleh & Waktu Bayar).
 * 2. Audit logs (Paid By, Paid At) fetched from payment_logs.
 * 3. Base/Overtime calculation is based on the new logic.
 */
public class ReportPanel extends JPanel {
    ...
    public ReportPanel() {
        ...
        // --- MODIFIKASI: Gunakan Background Image untuk Main Card ---
        ...
        // 2. TABEL AREA
        // --- PERUBAHAN: Tambah 2 Kolom (Dibayar Oleh dan Waktu Bayar) ---
        model = new DefaultTableModel(new String[]{
            "ID", "Nama", "Status Karyawan", "Tipe", "Gol", 
            "Gaji Pokok", "Lembur", "Hari Kerja", "Rate Harian", 
            "Total Gaji", "Status Payroll", "Dibayar Oleh", "Waktu Bayar" // <--- 13 KOLOM
        }, 0) {
        ...
        // --- MODIFIKASI: Transparansi Tabel agar Background Terlihat ---
    ...
    /**
     * Helper method: Mengambil log pembayaran dari tabel payment_logs
     */
